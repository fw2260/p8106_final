...
We found that from the 1994 US census dataset, boosting as well as random forest performed the best at classifying income to less than/equal to 50k or above 50k. This result was somewhat expected given that those models utilized the "wisdom of (weighted) crowds (experts)".
