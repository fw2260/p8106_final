...
![Continuous Predictors by Income Exploratory Analysis](./images/exploratory_box_plot.png){width=75%,height=50%}

![Categorical Predictors by Income Exploratory Analysis](./images/exploratory_bar_graph.png){width=75%,height=50%}

![Correlation Plot of All Predictors](./images/corr_plot.png){width=75%,height=50%}
